...
<li class="left_menu_item"><a id="ltg_title" href="index.html"><img src="images/ltg_logo.png" alt="Image" class="img-responsive left_menu_item" id="ltg_title"></a></li>
...
<div class="header menu hidden-xs hidden-sm">
  <div class="container-fluid header_grey">
    <ul class="left-menu">
      <li class="left_menu_item"><a id="ltg_title" href="index.html"><img src="images/ltg_logo.png" alt="Image" class="img-responsive left_menu_item" id="ltg_title"></a></li>
      <li class="active left_menu_item"><a href="index.html">Pagrindinis</a></li>
      <li class="left_menu_item"><a href="paslaugos.html">Paslaugos</a></li>
      <li class="left_menu_item"><a class="left_menu_item" href="http://facebook.com/liftingtogreatness">Straipsniai</a></li>
      <li class="left_menu_item"><a class="left_menu_item" href="kontaktai.html">Kontaktai</a></li>
      <li class="left_menu_item"><a class="left_menu_item" href="apie.html">Apie</a></li>
    </ul>
    <ul class="right-menu">
      <div class="dropdown">
      ...
      <a href="login.html" class="glyphicon glyphicon-user right_menu_item"></a>
    </ul>
  </div>
</div>
...
<script type="text/javascript">
  var userFeed = new Instafeed({
      ...
      template:
      '<div class="col-sm-3 insta_img"><a href="{{link}}"><img src="{{image}}"/></a></div>'
  });
  userFeed.run();
</script>
